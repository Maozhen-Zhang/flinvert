...
from Terminal.malclientF3BA import get_conv_weight_names, get_neuron_weight_names
from utils.function_normalization import tensor2Denormalize
from Functions.data import Subset

# from models_test.resnet import ResNet

class MalClientF3BA_(MalClient):
    def __init__(self, cfg, ID, train_dataset, test_dataset, identity="None"):
        super(MalClientF3BA_, self).__init__(cfg, ID, train_dataset, test_dataset, identity=identity)

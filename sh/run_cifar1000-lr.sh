...
python main.py --config conf_cifar10 --defense fedavg --attack noatt  --wandb --project flinvert-vgg-cifar10
python main.py --config conf_cifar10_earlystop --defense fedavg --attack dba --wandb --project flinvert-vgg-cifar10
python main.py --config conf_cifar10_earlystop --defense fedavg --attack flinvert --wandb --project flinvert-vgg-cifar10
python main.py --config conf_cifar10_earlystop --defense fedavg --attack flinvert --inject_params --threshold 0.0005 --delta 0.0001 --wandb --project flinvert-vgg-cifar10
